...
declare type TLeonardoModels = 'Dreamshape v7' | 'Dreamshape v6' | 'Dreamshape v5' | 'Dreamshape v3.2' | 'Leonardo Signature' | 'Leonardo Creative' | 'Leonardo Select' | 'Leonardo Diffusion' | 'Deliberate 1.1' | 'RPG 4.0' | 'Absolute Reality v1.6' | 'SDXL0.9' | '3D Animation Style' | 'Spirit Creatures' | 'Character Portraits' | 'Pixel Art' | 'Isometric Fantasy' | 'Isometric Asteroid Tiles' | 'Crystal Deposits' | 'Crystal Deposits Alternate' | 'Amulets' | 'Sheilds' | 'Chest Armor' | 'Magic Potions' | 'Magic Items' | 'Vintage Style Photography' | 'RPG v5' | 'Anime Pastel Dream' | 'Battle Axes' | 'Isometric Scifi Buildings' | 'Christmas Stickers' | 'Cute Characters' | 'Cute Animal Characters';
export interface ImageGenerateParams {
     ...
     */
    model?: (string & {}) | 'dall-e-2' | 'dall-e-3' | TLeonardoModels | null;
    /**
     * The number of images to generate. Must be between 1 and 10. For `dall-e-3`, only
     * `n=1` is supported.
     */
