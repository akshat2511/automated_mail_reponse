...
export declare type ChatCompletionContentPart = ChatCompletionContentPartText | ChatCompletionContentPartImage;
...
export declare type ChatCompletionMessageParam = ChatCompletionSystemMessageParam | ChatCompletionUserMessageParam | ChatCompletionAssistantMessageParam | ChatCompletionToolMessageParam | ChatCompletionFunctionMessageParam;
 ...
 */
export declare type ChatCompletionRole = 'system' | 'user' | 'assistant' | 'tool' | 'function';
 ...
 */
export declare type ChatCompletionToolChoiceOption = 'none' | 'auto' | ChatCompletionNamedToolChoice;
 ...
 */
export declare type CreateChatCompletionRequestMessage = ChatCompletionMessageParam;
export declare type ChatCompletionCreateParams = ChatCompletionCreateParamsNonStreaming | ChatCompletionCreateParamsStreaming;
export interface ChatCompletionCreateParamsBase {
     ...
     */
    model: (string & {}) | 'gpt-4-1106-preview' | 'gpt-4-vision-preview' | 'gpt-4' | 'gpt-4-0314' | 'gpt-4-0613' | 'gpt-4-32k' | 'gpt-4-32k-0314' | 'gpt-4-32k-0613' | 'gpt-3.5-turbo-1106' | 'gpt-3.5-turbo' | 'gpt-3.5-turbo-16k' | 'gpt-3.5-turbo-0301' | 'gpt-3.5-turbo-0613' | 'gpt-3.5-turbo-16k-0613' | 'claude-instant-1' | 'claude-2' | 'codellama/CodeLlama-34b-Instruct-hf' | 'mistralai/Mistral-7B-Instruct-v0.1' | 'HuggingFaceH4/zephyr-7b-beta';
    /**
 ...
 */
export declare type CompletionCreateParams = ChatCompletionCreateParams;
 ...
 */
export declare type CompletionCreateParamsNonStreaming = ChatCompletionCreateParamsNonStreaming;
 ...
 */
export declare type CompletionCreateParamsStreaming = ChatCompletionCreateParamsStreaming;
